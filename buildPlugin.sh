...
main() {
    ...
    # Every package must be assembled from a clean output tree. This also
    # enforces the project rule that an old plugin build is removed first.
    ...
    local project_react_pkgs="com.sninsertpage.InsertPagePackage"
